...
namespace Org.Ethasia.Fundetected.Core.Maths.Tests
{
    public class BresenhamBasedHitArcGenerationAlgorithmTest
    {
        ...
        public void TestCircleArcWithRadiusTwoIsDrawnFromTopRightToBottomRight()
        {
            ...
            Assert.That(result[6].X, Is.EqualTo(2)); 
            Assert.That(result[6].Y, Is.EqualTo(1));   

            Assert.That(result[7].X, Is.EqualTo(3)); 
            Assert.That(result[7].Y, Is.EqualTo(1));   

            Assert.That(result[8].X, Is.EqualTo(3)); 
            Assert.That(result[8].Y, Is.EqualTo(2));   

            Assert.That(result[9].X, Is.EqualTo(3)); 
        ...
        public void TestCircleArcWithRadiusTwoIsDrawnFromTopRightToBottomLeft()
        {
            ...
            Assert.That(result[11].X, Is.EqualTo(3)); 
            Assert.That(result[11].Y, Is.EqualTo(1));               

            Assert.That(result[12].X, Is.EqualTo(3)); 
            Assert.That(result[12].Y, Is.EqualTo(2));   

            Assert.That(result[13].X, Is.EqualTo(3)); 
            Assert.That(result[13].Y, Is.EqualTo(3));   

            Assert.That(result[14].X, Is.EqualTo(2)); 
            Assert.That(result[14].Y, Is.EqualTo(3));   

            Assert.That(result[15].X, Is.EqualTo(1)); 
            Assert.That(result[15].Y, Is.EqualTo(3));                                                                                    
        }      
        ...
        public void TestCircleArcWithRadiusTwoIsDrawnFromTopRightToTopLeft()
        {
            ...
            Assert.That(result[12].X, Is.EqualTo(2)); 
            Assert.That(result[12].Y, Is.EqualTo(1));   

            Assert.That(result[13].X, Is.EqualTo(3)); 
            Assert.That(result[13].Y, Is.EqualTo(1));   

            Assert.That(result[14].X, Is.EqualTo(3)); 
            Assert.That(result[14].Y, Is.EqualTo(2));   

            Assert.That(result[15].X, Is.EqualTo(3)); 
            Assert.That(result[15].Y, Is.EqualTo(3));        

            Assert.That(result[16].X, Is.EqualTo(2)); 
            Assert.That(result[16].Y, Is.EqualTo(3));   

            Assert.That(result[17].X, Is.EqualTo(1)); 
            Assert.That(result[17].Y, Is.EqualTo(3));          

            Assert.That(result[18].X, Is.EqualTo(1)); 
            Assert.That(result[18].Y, Is.EqualTo(2));  
        ...
        public void TestCircleArcWithRadiusThreeIsDrawnFromBottomRightToBottomLeft()
        {
            ...
            Assert.That(result[7].X, Is.EqualTo(4)); 
            Assert.That(result[7].Y, Is.EqualTo(4));  

            Assert.That(result[8].X, Is.EqualTo(3)); 
            Assert.That(result[8].Y, Is.EqualTo(4));       

            Assert.That(result[9].X, Is.EqualTo(4)); 
            Assert.That(result[9].Y, Is.EqualTo(5));     

            Assert.That(result[10].X, Is.EqualTo(3)); 
            Assert.That(result[10].Y, Is.EqualTo(5)); 

            Assert.That(result[11].X, Is.EqualTo(2)); 
            Assert.That(result[11].Y, Is.EqualTo(5));   

            Assert.That(result[12].X, Is.EqualTo(2)); 
            Assert.That(result[12].Y, Is.EqualTo(4));   

            Assert.That(result[13].X, Is.EqualTo(2)); 
            Assert.That(result[13].Y, Is.EqualTo(3));                                                                                                                                
        }  
        ...
        public void TestCircleArcWithRadiusFourIsDrawnFromBottomRightToBottomLeft()
        {
            ...
            Assert.That(result[0].X, Is.EqualTo(4)); 
            Assert.That(result[0].Y, Is.EqualTo(4));  

            Assert.That(result[1].X, Is.EqualTo(5)); 
            Assert.That(result[1].Y, Is.EqualTo(8));     

            Assert.That(result[2].X, Is.EqualTo(4)); 
            Assert.That(result[2].Y, Is.EqualTo(8)); 

            Assert.That(result[3].X, Is.EqualTo(3)); 
            Assert.That(result[3].Y, Is.EqualTo(8)); 

            Assert.That(result[4].X, Is.EqualTo(2)); 
            Assert.That(result[4].Y, Is.EqualTo(7)); 

            Assert.That(result[5].X, Is.EqualTo(1)); 
            Assert.That(result[5].Y, Is.EqualTo(6));    

            Assert.That(result[6].X, Is.EqualTo(0)); 
            Assert.That(result[6].Y, Is.EqualTo(5));       

            Assert.That(result[7].X, Is.EqualTo(4)); 
            Assert.That(result[7].Y, Is.EqualTo(5));  

            Assert.That(result[8].X, Is.EqualTo(5)); 
            Assert.That(result[8].Y, Is.EqualTo(6));       

            Assert.That(result[9].X, Is.EqualTo(5)); 
            Assert.That(result[9].Y, Is.EqualTo(7));     

            Assert.That(result[10].X, Is.EqualTo(4)); 
            Assert.That(result[10].Y, Is.EqualTo(6)); 

            Assert.That(result[11].X, Is.EqualTo(4)); 
            Assert.That(result[11].Y, Is.EqualTo(7));   

            Assert.That(result[12].X, Is.EqualTo(3)); 
            Assert.That(result[12].Y, Is.EqualTo(6));   

            Assert.That(result[13].X, Is.EqualTo(3)); 
            Assert.That(result[13].Y, Is.EqualTo(7));   

            Assert.That(result[14].X, Is.EqualTo(3)); 
            Assert.That(result[14].Y, Is.EqualTo(5));     

            Assert.That(result[15].X, Is.EqualTo(2)); 
            Assert.That(result[15].Y, Is.EqualTo(5));        

            Assert.That(result[16].X, Is.EqualTo(3)); 
            Assert.That(result[16].Y, Is.EqualTo(4));   

            Assert.That(result[17].X, Is.EqualTo(1)); 
            Assert.That(result[17].Y, Is.EqualTo(5));                                                                                                                     
        }                            
    }
}