...
{
    public class PlusMinMaxLightningDamageAffix : EquipmentAffix, IAffixWithTwoIntegers
    {
        ...
        {
            PlusMinMaxLightningDamageAffix copy = new PlusMinMaxLightningDamageAffix(plusMinDamageValue, plusMaxDamageValue);
            Clone(copy);
